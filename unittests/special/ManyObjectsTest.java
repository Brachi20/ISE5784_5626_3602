...
//
//
//            scene.geometries.add(new Sphere(new Point( randI,  randJ, randK),(double) size)
...
//        scene.lights.add(new SpotLight(new Color(400, 400, 400), new Point(0, 250, 300),new Vector(0, -1, 0)).setKl(4E-5)
//                .setKq(2E-7));
//
...
//        scene.lights.add(new SpotLight(new Color(250, 250, 250), new Point(-200, 200, 200), new Vector(-1, -1, -1)).setKl(4E-5)
//                .setKq(2E-7));
//
...
//
//
//        cameraBuilder.setVpSize(new Point(0, 1300, 150), new Point(0, 0, 100))
//                .setVpDistance(250) //
